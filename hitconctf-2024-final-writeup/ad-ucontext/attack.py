...
def parse_args():
    ...
    parser.add_argument('-u', '--server-url', metavar='URL',
                        default='http://attack.hitcon:5000',
                        help='Server URL')
    ...
    parser.add_argument('--token', metavar='TOKEN',
                        ...
                        default='shiny_sword_my_diamond')
    ...
    parser.add_argument('--attack-period', metavar='N', type=float, default=240,
